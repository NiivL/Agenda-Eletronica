...
<head>
    ...
    <link rel="stylesheet" href="<?php echo DIRPAGE.'Calendario/lib/css/style.css'; ?>">
    <link rel="stylesheet" href="<?php echo DIRPAGE.'Calendario/lib/js/Fullcalendar/main.min.css'; ?>">
